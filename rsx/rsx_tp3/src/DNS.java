...
public class DNS {
	...
	public static byte[] createRequestData(String requete) {
		...
		String[] addressSplit = requete.split("[.]");
	...
	public static void afficheAnalysePaquet(byte[] msg) {
		...
		System.out.println("QDCount (Question) : "+ getHexaString(getShortValue(msg, i)));
		i += 2;
	...
	System.out.println("ARCount (Additionnelles) : "+ getHexaString(nbAutres));
			i += 2;
